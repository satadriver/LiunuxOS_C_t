...
#define INFILE_DOS_PROCESS_FLAG 0X80000000
...
extern "C"  __declspec(dllexport) DWORD __kTaskSchedule(CONTEXT_REGS*);
...
extern "C"  __declspec(dllimport) DWORD __kTaskSchedule(CONTEXT_REGS*);
