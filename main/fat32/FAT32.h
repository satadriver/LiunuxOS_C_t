...
extern "C" __declspec(dllexport) int getNextFAT32Cluster(int no);
#else
...
extern "C" __declspec(dllimport) int getNextFAT32Cluster(int no);
#endif
...
int getNextFAT32EmptyCluster(int no);
