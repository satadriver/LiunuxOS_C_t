...
extern "C" __declspec(dllexport) int asc2unicode(char * asc, int asclen,char * unicode);

extern "C" __declspec(dllexport) int unicode2asc(char * unicode,int unicodelen,char * asc);
#else
...
extern "C" __declspec(dllimport) int asc2unicode(char * asc, int asclen, char * unicode);

extern "C" __declspec(dllimport) int unicode2asc(char * unicode, int unicodelen, char * asc);
#endif
